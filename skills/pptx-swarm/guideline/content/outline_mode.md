...
2. Faithful to user outline: Build upon the user's original points in the outline without deviating from the outline direction; in Information Supplementation Mode, active expansion is encouraged as long as supplemented content serves the original points without overshadowing them
